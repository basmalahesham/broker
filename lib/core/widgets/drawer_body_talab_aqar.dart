                ...
                Form(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 8.h),
                      CustomRowCheck(text: 'مدخل سيارة'),
                      SizedBox(height: 8.h),
                      CustomRowCheck(text: 'غرفة سايق'),
                      SizedBox(height: 8.h),
                      CustomRowCheck(text: 'غرفة خادمة'),
                      SizedBox(height: 8.h),
                      CustomRowCheck(text: 'مسبح'),
                      SizedBox(height: 8.h),
                      CustomRowCheck(text: 'مؤثث'),
                      SizedBox(height: 8.h),
                      Row(
                        children: [
                          Column(
                      ...
                      SizedBox(height: 8.h),
                      CustomRowCheck(text: 'قبو'),
                      SizedBox(height: 8.h),
                      CustomRowCheck(text: 'الاعلانات المصورة فقط'),
                      SizedBox(height: 8.h),
                      SizedBox(
                        width: 311.w,
                        height: 30.h,
